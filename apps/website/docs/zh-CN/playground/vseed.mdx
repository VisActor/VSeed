...
const Demo = () => {
  ...
  const vseed: VSeed = {
    ...
    dataset: [
      ...
      { continent: 'Oceania', Country: 'Australia', LifeExpectancy: 31.235, GDP: 34435.36744, Population: 434176 },
      { continent: 'Oceania', Country: 'New Zealand', LifeExpectancy: 30.204, GDP: 25185.00911, Population: 3115771 },
    ].filter(v => ['Asia', 'Oceania'].includes(v.continent)),
    measures: [
