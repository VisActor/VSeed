...
import { ColumnPercentChart, CombinationColumnPercentChart, PivotColumnPercentChart } from '@components'
...
<CombinationColumnPercentChart />

```json title="组合百分比柱状图" {2,4-30}
{
  "chartType": "columnPercent",
  "measures": [
    {
