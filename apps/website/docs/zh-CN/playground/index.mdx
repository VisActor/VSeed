...
const Demo = () => {
  ...
  const vseed: VSeed = {
    ...
    measures: [
      { id: 'profit', alias: '利润', encoding: 'primaryYAxis', parentId: 'test' },
      { id: 'sales', alias: '销售额', encoding: 'secondaryYAxis', parentId: 'test2' },
      { id: 'count', alias: '数量', encoding: 'tooltip', parentId: 'test2' },
    ],
  }
