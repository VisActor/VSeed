...
import { BarPercentChart, CombinationBarPercentChart, PivotBarPercentChart } from '@components'
...
<CombinationBarPercentChart />

```json title="组合百分比条形图" {2,4-14}
{
  "chartType": "barPercent",
  "measures": [
    {
